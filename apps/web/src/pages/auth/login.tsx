...
export default function Login() {
  ...
  return (
    <>
      <Head>
        <title>Sign In - Mental Wellness App</title>
        <meta name="description" content="Sign in to your mental wellness account" />
      </Head>
            ...
            <form className="space-y-6" onSubmit={handleLogin}>
              ...
              <div className="flex items-center justify-between">
                <div className="text-sm">
                  <Link href="/auth/forgot-password" className="font-medium text-wellness-600 hover:text-wellness-500">
            ...
            <div className="mt-6">
              <div className="text-center">
                <span className="text-sm text-gray-600">
                  ...
                  <Link href="/auth/signup" className="font-medium text-wellness-600 hover:text-wellness-500">
                    Sign up
                  </Link>
                </span>
              </div>
